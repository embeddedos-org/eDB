...
def app_client():
    ...
    state.user_manager.ensure_admin_exists(username="admin", password="Admin@12345678!")
    app.state.edb = state
...
def admin_token(app_client):
    ...
    resp = app_client.post("/auth/login", json={"username": "admin", "password": "Admin@12345678!"})
