...
SEGMENTS = [
    {"id": "intro", "text": "Introducing eDB. Unified Multi-Model Database."},
    {"id": "f1", "text": "Feature one. Relational + Document + Graph. Single engine supports SQL tables, JSON documents, and graph traversals."},
    ...
    {"id": "arch", "text": "Under the hood, eDB is built with Python, SQLAlchemy, PostgreSQL. The architecture flows from Query Parser, to Optimizer, to Storage Engine, to Replication, to WAL."},
    {"id": "cta", "text": "eDB. Open source and production ready. Visit github dot com slash embeddedos-org slash eDB."},
]
